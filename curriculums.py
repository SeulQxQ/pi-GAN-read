...
CelebA = {
    0: {'batch_size': 10  * 2, 'num_steps': 12, 'img_size': 64, 'batch_split': 5, 'gen_lr': 6e-5, 'disc_lr': 2e-4},
    int(200e3): {},
...
CARLA = {
    0: {'batch_size': 9, 'num_steps': 48, 'img_size': 32, 'batch_split': 3, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    int(10e1): {'batch_size': 3, 'num_steps': 36, 'img_size': 64, 'batch_split': 3, 'gen_lr': 2e-5, 'disc_lr': 2e-4}, 
    int(55e1): {'batch_size': 2, 'num_steps': 24, 'img_size': 128, 'batch_split': 2, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    int(200e1): {},

    'dataset_path': 'datasets/carla/*.png',
    'fov': 30,
    'ray_start': 0.7,
    'ray_end': 1.3,
    'fade_steps': 10000,
